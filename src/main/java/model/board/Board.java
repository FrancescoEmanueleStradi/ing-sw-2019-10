...
public class Board {
    ...
    public Board(int type) {
        ...
        /*model.cards.WeaponCard wc1
        model.cards.WeaponCard wc2
        model.cards.WeaponCard wc3
        model.cards.WeaponCard wc4
        model.cards.WeaponCard wc5
        model.cards.WeaponCard wc6
        model.cards.WeaponCard wc7
        model.cards.WeaponCard wc8
        model.cards.WeaponCard wc9
