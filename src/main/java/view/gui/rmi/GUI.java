...
import view.*;
import view.gui.common.*;
import view.gui.rmi.actions.grab.Grab1;
import view.gui.rmi.actions.grab.Grab2;
import view.gui.rmi.actions.move.Move1;
import view.gui.rmi.actions.move.Move2;
import view.gui.rmi.actions.shoot.Shoot1;
import view.gui.rmi.finalfrenzy.*;
import view.gui.rmi.powerups.*;
