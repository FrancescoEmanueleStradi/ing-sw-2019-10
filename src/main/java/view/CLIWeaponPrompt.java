...
public class CLIWeaponPrompt {
    ...
    public void shoot2ToUser1(Game game, String nickName) throws InvalidColourException {
        Scanner in = new Scanner(System.in);
        String s = in.next();
        int i;
        List<Integer> lI = new LinkedList<>();
   ...
   public void shootToUser2(Game game, String nickName) throws InvalidColourException {
    ...
    public void shoot2ToUser2(Game game, String nickName) throws InvalidColourException {
        Scanner in = new Scanner(System.in);
        String s = in.next();
        int i;
        List<Integer> lI = new LinkedList<>();
    ...
    public void shoot2ToUser3(Game game, String nickName) throws InvalidColourException {
        Scanner in = new Scanner(System.in);
        String s = in.next();
        int i;
        List<Integer> lI = new LinkedList<>();
    ...
    public void shoot2ToUser4(Game game, String nickName) throws InvalidColourException {
        Scanner in = new Scanner(System.in);
        String s = in.next();
        int i;
        List<Integer> lI = new LinkedList<>();
